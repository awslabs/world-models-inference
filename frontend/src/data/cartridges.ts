...
export const CARTRIDGES: Cartridge[] = [
  ...
  },
  {
    ...
    deploy: ['ec2', 'sagemaker'],
    hue: 340,
    upstream: 'https://github.com/SkyworkAI/Matrix-Game/tree/main/Matrix-Game-3',
    license: 'Apache-2.0',
    notes: 'Validated on a real p5.48xlarge: WASD + IJKL over a WebSocket session, JPEG frames back. 832x480, 3-step distilled, int8 + LightVAE. ~35fps sustained on 8 GPUs measured through the endpoint. Actions apply per chunk (57 frames then 40), not per frame.',
  },
  {
    id: 'waypoint-1-5',
    name: 'Waypoint 1.5',
    type: 'real-time',
    tagline: 'Overworld real-time diffusion world model — WASD + mouse on a single H100.',
    instance: 'p5.4xlarge',
    gpu: '1× H100 80GB',
    ...
    deploy: ['ec2'],
    hue: 30,
    upstream: 'https://huggingface.co/Overworld/Waypoint-1.5-1B',
    license: 'Apache-2.0',
    notes: 'Real-time diffusion world model on one GPU. Measured 82 fps delivered at 720p on a p5.4xlarge H100 (fp8 w8a8), 25 fps on an A10G (int8) at the same resolution; <5GB VRAM. Weights are Apache-2.0; the world_engine runtime baked into the image is GPL-3.0.',
  },
  {
    id: 'vjepa2-ac',
    name: 'V-JEPA 2-AC',
